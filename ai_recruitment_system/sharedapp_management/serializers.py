...
class UserSerializer(serializers.ModelSerializer):
    ...
    def get_password_strength(self, obj):
        ...
        password = (
            self.initial_data.get("password", None)
    ...
    def create(self, validated_data):
        ...
        if role not in ["user", "recruiter", "admin"]:
            raise serializers.ValidationError(
                "Invalid role. Must be 'user', 'recruiter', or 'admin'."
            )
...
class CompanySerializer(serializers.ModelSerializer):
    ...
    c_address= serializers.PrimaryKeyRelatedField(read_only=True)
...
class AddressSerializer(serializers.ModelSerializer):
    ...
    c_id = serializers.PrimaryKeyRelatedField(
